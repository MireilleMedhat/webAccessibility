...
class AccordionComponent extends Component {
  state = {
    accordion: Array.prototype.slice.call(
  ...
  // panels = bodies
  handleKeyDown = event => {
    // var allowMultiple = event.target.hasAttribute("data-allow-multiple");
    // // Allow for each toggle to both open and close individually
    // var allowToggle = allowMultiple
    //   ? allowMultiple
    //   : event.target.hasAttribute("data-allow-toggle");
    // if (!allowToggle) {
    //   // Get the first expanded/ active accordion
    //   var expanded = event.target.querySelector('[aria-expanded="true"]');
    ...
    var triggers = Array.prototype.slice.call(
      event.target.querySelectorAll(".Accordion-trigger")
    );
    ...
    var panels = Array.prototype.slice.call(
      event.target.querySelectorAll(".Accordion-panel")
    );
  ...
  handleClick = event => {
    ...
    var allowToggle = allowMultiple
      ? allowMultiple
      : target.hasAttribute("data-allow-toggle");
    if (!allowToggle) {
      // Get the first expanded/ active accordion
      var expanded = target.querySelector('[aria-expanded="true"]');
    ...
    if (target.classList.contains("Accordion-trigger")) {
      ...
      var active = target.querySelector('[aria-expanded="true"]');
...
// });
/////////////////////////////// OLD OLD OLD ///////////////////////////////
// TRIAL TO CONVERT JS FILE INTO REACT FUNCTIONS USEFUL FOR LATER
//   handleKeyDown = event => {
//     var triggers = Array.prototype.slice.call(
//       event.target.querySelectorAll(".Accordion-trigger")
//     );
...
//       <div className="App">
//         <form>
//           <dl id="accordionGroup" role="presentation" className="Accordion">
//             <dt role="heading" aria-level={3}>
//               <button
//                 aria-expanded="true"
//                 className="Accordion-trigger"
